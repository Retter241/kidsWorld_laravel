...
<li class="active">
                ...
                <ul class="collapse list-unstyled" id="homeSubmenu">
                 ...
                 --}}
            <li>
                <a href="{{ action('Admin\CategoryController@index') }}">Категории</a>
                <a href="{{ action('Admin\PostController@index') }}">Новости</a>
                <a href="{{ action('Admin\TopicController@index') }}">Темы форума</a>
                <a href="{{ action('Admin\CommentController@index') }}">Комментарии</a>
                <a href="{{ action('Admin\UserController@index') }}">Пользователи</a>
            </li>
...
<g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                    ...
                    <div class="collapse navbar-collapse pull-right" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="{{ action('Admin\TestController@index') }}" target="_blank" style="color: red;display: none;">Test</a>
                            </li>
